...
export default function Navbar() {
    ...
    <ul style={{maxWidth: "600px", minWidth: "80%", display: "flex", justifyContent: "space-between", alignItems: "center"}} className="text-slate-900 text-xl space-x-4">
        ...
        {session.status == "authenticated" ? <button style={{textAlign: "center", backgroundColor: "#A78BFA", margin: 0, padding: "5px", borderRadius: "5px", width: "20%"}} onClick={() => signOut()}>Sign Out</button> : <button style={{textAlign: "center", backgroundColor: "#A78BFA", margin: 0, padding: "5px", borderRadius: "5px", width: "30%"}} onClick={() => signIn()}>Login</button>}
    </ul>
</nav>
}